...
run(function () {
    ...
    $username = 'Token|' . $config['access_key'] . '|' . $config['instance_id'];
    // Token模式，token 需要提前向自己的应用服务提供方申请，此处以读写权限类型的 token 为例
    // @see https://help.aliyun.com/document_detail/163049.htm
    $tokenStr = '';
